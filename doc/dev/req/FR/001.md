...
Eventually, I want to have `email to path` mappings, populated from existing directories and from missing directories.

Such mappings should serve as configurable routing rules. Maybe even shareable in a community of users for rule crowdsourcing.

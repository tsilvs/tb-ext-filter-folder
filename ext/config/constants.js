...
export const DEFAULT_FILTER_CONFIG = [
	{
		id: "preJunk",
		value: FILTER_TYPES.PRE_JUNK,
		label: "optPreJunk",
		enabled: false,
	},
	{
		id: "manual",
		value: FILTER_TYPES.MANUAL,
		label: "optManual",
		enabled: true,
	},
	{
		id: "postJunk",
		value: FILTER_TYPES.POST_JUNK,
		label: "optPostJunk",
		enabled: true,
	},
	{
		id: "sending",
		value: FILTER_TYPES.SENDING,
		label: "optSending",
		enabled: false,
	},
	{
		id: "archive",
		value: FILTER_TYPES.ARCHIVE,
		label: "optArchive",
		enabled: false,
	},
	{
		id: "periodic",
		value: FILTER_TYPES.PERIODIC,
		label: "optPeriodic",
		enabled: false,
	},
];
...
export const DEFAULT_CONFIG = {
	mergeCase: true,
	scanLimit: LIMITS.DEFAULT_SCAN_LIMIT,
	defaultRoot: "",
	folderRoot: "",
...
export const REGEX_PATTERNS = {
	...
	EMAIL_CONDITION: /\(from\s*,\s*(?:contains|is)\s*,\s*([^)]+)\)/,
